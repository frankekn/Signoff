...
- `PUSH.json` — independent advisor routes, falsifiable criteria, risks, and a synthesis;
...
Use `./signoff next` for the current path and `./signoff integrity` to revalidate locks and receipts.
