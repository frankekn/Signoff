...
**Push phase:** `PUSH.json` is the output. `./traction lock` rejects fake quorum, duplicate contexts, missing route synthesis, unresolved verdict-split conflicts, unsupported chair overrides of unanimous advisors, and vote-based arbitration.
