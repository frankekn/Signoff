...
- `DONE`: final cumulative contract covers all locked requirements/criteria, verification passes, independent Pull passes, and no `ACT_ON` remains.
- `ACCEPTED`: current non-final slice passes; return to the locked run for another bounded slice.
