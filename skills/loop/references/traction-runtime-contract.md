...
**Push phase:** `PUSH.json` is the output. `./traction lock` rejects fake quorum, duplicate contexts, unresolved verdict-split conflicts, unresolved route divergence, unsupported chair overrides of unanimous advisors, and vote-based arbitration.
