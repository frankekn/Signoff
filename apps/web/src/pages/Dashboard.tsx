...
const phaseCopy: Record<string, { title: string; note: string }> = {
  ...
  PUSH: { title: 'Push: challenge the route', note: 'Independent advisors propose the smallest viable route and what would prove it wrong.' },
  ...
  REVIEWING: { title: 'Pull: independent review in progress', note: 'Each criterion must be PASS, FAIL, or UNKNOWN; unresolved doubt cannot be hidden.' },
